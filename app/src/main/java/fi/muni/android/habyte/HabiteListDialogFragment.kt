...
import fi.muni.android.habyte.databinding.FragmentItemListDialogListDialogItemBinding
import fi.muni.android.habyte.databinding.FragmentItemListDialogListDialogBinding
 ...
 * </pre>
 */
class HabiteListDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.findViewById<RecyclerView>(R.id.list)?.adapter =
            arguments?.getInt(ARG_ITEM_COUNT)?.let { HabiteAdapter(it) }
    }
    ...
    private inner class HabiteAdapter internal constructor(private val mItemCount: Int) :
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): HabiteListDialogFragment =
            HabiteListDialogFragment().apply {
